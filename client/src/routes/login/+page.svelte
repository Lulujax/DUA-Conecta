	...
	<div class="auth-card">
		...
		<form onsubmit={handleLogin}>
			<div class="form-group">
				...
				<input type="email" id="email" bind:value={email} placeholder="tu@email.com" autocomplete="email" required class="themed-input" />
			</div>
			...
			<div class="form-group">
				...
				<input type="password" id="password" bind:value={password} placeholder="••••••••" autocomplete="current-password" required class="themed-input" />
			</div>
