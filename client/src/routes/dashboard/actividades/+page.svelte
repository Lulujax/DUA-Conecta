                ...
                <div class="activity-card" in:fly={{ y: 20, duration: 400, delay: i * 50 }}>
                    <div class="card-image">
                        ...
                        <div class="overlay-actions">
                            <a href="/editor/{activity.template_id}?activityId={activity.id}&name={encodeURIComponent(activity.name)}" class="btn-icon edit" title="Editar" aria-label="Editar">
                                <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M17 3a2.828 2.828 0 1 1 4 4L7.5 20.5 2 22l1.5-5.5L17 3z"></path></svg>
                            </a>
                            <button class="btn-icon delete" onclick={() => handleDelete(activity.id)} title="Eliminar" aria-label="Eliminar">
